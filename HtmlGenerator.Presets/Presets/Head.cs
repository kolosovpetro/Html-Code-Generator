...
namespace HtmlGenerator.Presets.Presets
{
    public static class Head
    {
        public static IEnumerable<string> GetHead(string title)
        {
            ...
            yield return "<html prefix=\"og: http://ogp.me/ns#\">";
            yield return "<meta name=\"twitter:card\" content=\"summary\" />";
            yield return
            ...
            yield return
                $"<link rel=\"icon\" type=\"image/png\" href=\"{Domain.MainDomain}css/favicon-16x16.png\" sizes=\"16x16\" />";
            yield return
