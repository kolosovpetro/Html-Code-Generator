namespace HtmlGenerator.Routes.Route
{
    public static class Title
    {
        ...
        public static class ClassicalAlgorithms
        {
            ...
            public const string SieveOfEratosthenes = "Sieve Of Eratosthenes";
            public const string EuclideanGcd = "Euclidean Gcd";
            public const string MaximumSubarraySum = "Maximum Subarray Sum";
            public const string ClosestPairProblem = "Closest Pair Problem";
            public const string ShuntingYard = "Shunting-Yard Algorithhm";
            public const string KadaneAlgorithm = "Kadane Algorithm";
        }
        ...
        {
            public const string Root = "Heap Algorithms";
        ...
        {
            public const string Root = "Tree Algorithms";
        }

        public static class GraphAlgorithms
        {
            public const string Root = "Graph Algorithms";
            public const string DijkstraAlgorithm = "Dijkstra Algorithm";
            public const string BreadthFirst = "Breadth-First Graph Traversal";
            public const string DepthFirstIterative = "Depth-First Graph Traversal Iterative";
            public const string DepthFirstRecursive = "Depth-First Graph Traversal Recursive";
            public const string KahnAlgorithm = "Kahn Algorithm (Topological Sort)";
        }

        public static class SortAlgorithms
        {
            public const string Root = "Sort Algorithms";
